...
if __name__ == "__main__":
    subs = np.loadtxt("/home/ngaggion/DATA/HybridGNet3D/Dataset/VolumetricFiles/vol_subparts.txt", dtype=str)
    faces = np.load("/home/ngaggion/DATA/HybridGNet3D/Dataset/VolumetricFiles/vol_faces.npy")
    ...
    for i in range(len(split)):
        ...
        points1 = np.load("/home/ngaggion/DATA/HybridGNet3D/BaselineChen/Volumetric/seg_noLAX_vol/Meshes/" + str(subject) +"/"+ time+ "/mesh.npy")
        points2 = np.load("/home/ngaggion/DATA/HybridGNet3D/Backup/Dataset/Meshes/VolumetricMeshes/" + str(subject) +"/"+ time+ "/fhm_vol.npy")
    ...
    results.to_csv("results_volumetric.csv", index=False)