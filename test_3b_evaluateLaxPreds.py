...
def eval(model_path):
    ...
    for subject in subjects:
        ...
        for time in timesteps:
            ...
            gt_2CH_path = os.path.join("../Dataset/LaxMasks/", subject.split('/')[-1], time.split('/')[-1], "2CH.nii.gz")
            gt_4CH_path = os.path.join("../Dataset/LaxMasks/", subject.split('/')[-1], time.split('/')[-1], "4CH.nii.gz")
